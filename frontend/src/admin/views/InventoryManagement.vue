            ...
            <div class="mt-3 space-y-2">
              ...
              >
                ...
                <div class="text-right">
                  <span class="font-bold text-[#2d5a43]">{{ r.quantity_used }} {{ r.unit }}</span>
      ...
      <div class="bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl space-y-4">
        ...
        <div>
          <input 
            ...
            step="0.1" 
            v-model="adjustQty"
            class="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-base font-bold text-slate-900 text-center focus:ring-2 focus:ring-[#2d5a43] focus:outline-none"
          />
        </div>
